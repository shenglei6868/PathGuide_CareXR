...
export class UI extends BaseScriptComponent {
  ...
  get loadPathClicked() {
    return this.loadPathClickedEvent.publicApi()
  }
  ...
  private loadPathClickedEvent: Event = new Event()
  ...
  showArrivedUi() {
    this.tryHideCurrentActive()
    this.goToStartUiDistance.text = "ARRIVED!"
  ...
  onLoadPathButton() {
    this.hide(this.homeTr)
    this.loadPathClickedEvent.invoke()
  }
